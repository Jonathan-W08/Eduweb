  ...
  return (
    <div className="flex flex-wrap p-8">
      ...
      <div className="flex flex-row justify-between w-full">  
        <img src="./public/img/webinar.jpg" alt="" style={{width:"840px",height:"400px"}}/>

          
      <div>
        <div className=" flex flex-col justify-start p-10 m-10"  style={{width:"500px", height:"250px", backgroundColor:"white"}}>
      ...
      <div className="flex flex-row justify-between w-full">
      <div className="p-8" style={{width:"840px", height:"200px", backgroundColor:"white"}}>
        <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white" >
    Deskripsi
      </h5>
...
<br />#GrowTogetherWithIL
   ...
   <div className="flex flex-col justify-center p-10 mx-10" style={{width:"505px", height:"200px", backgroundColor:"white"}}>
    ...
    <IoTicketSharp style={{width:"130px", height:"100px"}} />
      ...
      <h5 className="flex  text-2xl font-tracking-tight text-gray-900 dark:text-white ">Harga</h5>
      <h5 className="flex text-end text-2xl font-tracking-tight text-gray-900 dark:text-white ">Gratis</h5>
      </div>
