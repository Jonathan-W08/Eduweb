...
const Webinar = () => {
  return (
    <div className="flex flex-col">
      <div>
        <h5
          className="text-5xl font-bold tracking-tight text-gray-900 dark:text-white mx-20"
      ...
      <div className="flex flex-row justify-evenly items-center">
        ...
        >
          ...
          >
            ...
            <h1 style={{ fontSize: "30px", lineHeight: "2" }}>Pembayaran</h1>
            ...
            <div className="flex max-w-md flex-col gap-4" id="checkbox">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="qris" style={{ fontSize: "25px" }}>
                  QRIS&nbsp;
                </Label>
              </div>
            </div>
